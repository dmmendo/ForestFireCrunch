...
json.dump(max_val_results.tolist(),open("max_val_doptdatalimit30_predmae_10sim.json","w"))


json.dump(this_train_sizes.tolist(),open("trainsize_doptdatalimit30_predmae_10sim.json","w"))
